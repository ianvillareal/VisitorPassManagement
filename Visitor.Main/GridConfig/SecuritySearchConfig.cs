...
{
    internal class SecuritySearchConfig
    {
        internal static void GenerateGridConfig(GridDefaults defaultSettings)
        {
            try
            {
                MVCGridDefinitionTable.Add("SecuritySearch", new MVCGridBuilder<VisitorSearchResultViewModel>(defaultSettings)
                ...
                .AddColumns(column =>
                {
                    column.Add("Actions")
                            ...
                            .WithValueTemplate("<a href=\"/Security/View/{Model.RequestId}\"><span class=\"glyphicon glyphicon-search space rilv-icon-color\" data-blockui=\"true\" /></a>")
