...
{
    internal class VisitorSearchConfig
    {
        internal static void GenerateGridConfig(GridDefaults defaultSettings)
        {
            try
            {
            MVCGridDefinitionTable.Add("VisitorSearch", new MVCGridBuilder<VisitorSearchResultViewModel>(defaultSettings)
            ...
            .AddColumns(column =>
            {
                column.Add("Actions")
                        ...
                        .WithValueTemplate("<a href=\"/Visitor/View/{Model.RequestId}\"><span class=\"glyphicon glyphicon-search space rilv-icon-color\" data-blockui=\"true\" /></a>" +
                        "<a href=\"/Visitor/Edit/{Model.RequestId}\"><span class=\"glyphicon glyphicon-edit space rilv-icon-color\" data-blockui=\"true\" /></a>")
                ...
                column.Add("Status").WithHeaderText("Status")
                        ...
                        .WithCellCssClassExpression(v => v.Status == StatusType.ForApproval ? "center-icon" : "center-icon")
                        .WithSorting(false)
                        .WithFiltering(false);
            })
