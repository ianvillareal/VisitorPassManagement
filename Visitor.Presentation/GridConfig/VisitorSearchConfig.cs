        ...
        internal static void GenerateGridConfig(GridDefaults defaultSettings)
        {
            ...
            .AddColumns(column =>
            {
                column.Add("Actions")
                        ...
                        .WithValueTemplate("<a href=\"/Visitor/View/{Model.VisitorId}\"><span class=\"glyphicon glyphicon-search space\" data-blockui=\"true\" /></a>" +
                        "<a href=\"/Visitor/Edit/{Model.VisitorId}\"><span class=\"glyphicon glyphicon-edit space\" data-blockui=\"true\" /></a>")
